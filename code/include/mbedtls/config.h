...
/* ECC for MPKA key negotiation (CS.00172): P-224 only */
...
/**
 * \def MBEDTLS_MEMORY_DEBUG_VERBOSE
 *
 * Add more verbosity.
 *
 * Requires: MBEDTLS_MEMORY_DEBUG
 *
 * Uncomment this macro to increase memory printout verbosity.
 */
//#define MBEDTLS_MEMORY_DEBUG_VERBOSE
 ...
 */
/* ECC for MPKA key negotiation (CS.00172) */
...
/**
 * \def MBEDTLS_X509_CRT_SD15_C
 *
 * Enable X.509 SD.00015 parsing.
 *
 * Module:  library/sd15.c
 * Caller:  not defined
 *
 ...
 * To be completed.
 */
#define MBEDTLS_X509_CRT_SD15_C
...
/*
 * The SecurityLib ECC layer always passes an explicit RNG callback
 * (SecLib_RandomGenerate) to every ECP operation, so the internal
 * fallback DRBG (which would require HMAC_DRBG/CTR_DRBG, both absent
 * from this build) is compiled out via upstream's own switch.
 */
